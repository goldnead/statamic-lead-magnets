 ...
 *
 * Interfaces and value objects only. `TableMetric` is deliberately not among
 * them: it is a class with behaviour, a reflection of it says nothing about a
 * method body, and it is held to the original by a byte-for-byte file
 * comparison instead — see `InsightsContractsMatchTest`.
 *
